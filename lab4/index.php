...
<html lang="en">
  <head>
    ...
    <title> ITEC106 LABORATORY 4 </title>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="text-center mb-3">
                    <img id="view_image" src="" alt="Student Image" style="max-width: 100px; max-height: 100px; border: 4px solid gray;" class="img-fluid">
                </div>
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $student)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?= $student['image'] ?>" alt="Student Image" style="width: 120px; height: 120px;"></td>
                                        <td>
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (res.status == 404) {
                ...
                $('#view_image').attr('src', res.data.image); // Set the image source
